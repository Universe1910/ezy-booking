...
type EzyOrdersRequest struct {
	...
	CouponCode     *uint    `json:"couponCode" form:"couponCode"`
	...
	CustomerID    uint `json:"customerId" form:"customer_id" `
	AppointmentID uint `json:"appointmentId" form:"appointmentId"`
